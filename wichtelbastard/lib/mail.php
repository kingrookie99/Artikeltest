...
while($row = mysql_fetch_array($result))
{
   ...
   # if(!in_array($row['id'],$recipients)) continue;
    ...
    if($action == "mail1")
    {
        ...
        $bastard_subject = "Der Wichtelbastard informiert: Jetzt geht es lo-hos!";
        
        $message  = "";
        $message .= "Der Wichtelbastard höchstpersönlich hat heute um 12:23 Uhr den großen roten Knopf für die Auslosung des fantastischen cyclos-Weihnachtswichtelns gedrückt.\n\n";
        ...
        $message .= "Tragt bitte Eure Wünsche ein oder setzt den Haken für \"wunschlos glücklich, überrasch mich\", um ein optimales Wichtelerlebnis sicher zu stellen.\n\n";
